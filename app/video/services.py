...
async def save_video(
    ...
    if file.content_type == 'video/mp4':
        ...
        raise HTTPException(status_code=418, detail='Wrong file type! Only mp4 is allowed.')
...
async def open_file(request: Request, video_id: int) -> tuple:
    ...
    if content_range is not None:
        ...
        return ranged(file, start=range_start, end=range_end + 1), status_code, content_length, headers
